...
=======
\def\uTemp{w}
>>>>>>> 0897cb4433bce064c534bb97562b2c448cdb8182
\def\volMeas{\mu}
\def\surfMeas{S}
\begin{document}
...
\begin{equation}
\varrho c_P \frac{\partial \Temp}{\partial t} = \kappa \Delta \Temp , \text{ or }
\end{equation}
\begin{equation}
\frac{\partial T}{\partial t} = \alpha \Delta \Temp \text{ in } \Omega ,
\end{equation}
...
\frac{\partial \Temp}{\partial t} = \alpha \left( \frac{\partial^2 \Temp}{\partial x^2} + \frac{\partial^2 \Temp}{\partial y^2} \right) + f = \alpha \Delta \Temp + f .
\end{equation}
...
With no-flux boundary conditions, i.e. zero normal derivatives of $\uTemp $ at the boundary of $\Omega $ and time-constant bulk heating by internal heat sources $f$ solutions $\uTemp $ of the heat equation (\ref{HeatEquation2D}) will attain inifinite large temperatures when the time $t$ tends to infinity.
=======
\begin{theorem}[Satz von Pythagoras]
...
\bottomrule
\end{tabular}}
\caption{Solution to difeerent time frames.}
\label{SolutionsTimeframes1}
\end{table}
